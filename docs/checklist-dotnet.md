...
- [ ] Настроить инфраструктуру: PostgreSQL, Redis, Elasticsearch, MinIO/S3
- [ ] Создать базовый .NET 8 проект с общими зависимостями
...
### Этап 2: Files Service
- [ ] Создать базовую структуру проекта Files Service
- [ ] Реализовать модели данных и миграции EF Core
- [ ] Настроить интеграцию с MinIO/S3 для хранения файлов
- [ ] Реализовать загрузку и скачивание файлов с presigned URLs
- [ ] Добавить версионирование файлов
- [ ] Настроить антивирусное сканирование (ClamAV)
- [ ] Реализовать генерацию превью файлов
- [ ] Добавить тестирование и документацию

### Этап 3: Notifications Service
- [ ] Создать Notifications Service
- [ ] Реализовать модели данных для шаблонов и уведомлений
- [ ] Настроить интеграцию с SMTP для email уведомлений
- [ ] Реализовать WebPush уведомления
- [ ] Добавить In-App уведомления
- [ ] Настроить Hangfire для фоновой обработки
- [ ] Реализовать retry логику с exponential backoff
- [ ] Добавить тестирование и документацию

### Этап 4: Search Service
- [ ] Создать Search Service
- [ ] Настроить интеграцию с Elasticsearch/OpenSearch
- [ ] Реализовать индексы для задач, комментариев и файлов
- [ ] Настроить анализаторы для русского и английского языков
- [ ] Добавить полнотекстовый поиск с фильтрами
- [ ] Реализовать автодополнение поисковых запросов
- [ ] Настроить обработку событий для обновления индексов
- [ ] Добавить тестирование и документацию

### Этап 5: Reporting/Analytics Service
- [ ] Создать Reporting Service
- [ ] Реализовать модели данных для отчётов
- [ ] Настроить материализованные представления для быстрых отчётов
- [ ] Реализовать генерацию отчётов в различных форматах
- [ ] Добавить планировщик отчётов (Hangfire)
- [ ] Настроить экспорт в CSV, Excel, PDF
- [ ] Реализовать кэширование результатов отчётов
- [ ] Добавить тестирование и документацию

### Этап 6: Интеграция с Java сервисами
- [ ] Настроить Kafka consumer'ы для событий от Java сервисов
- [ ] Реализовать обработку событий: task.*, comment.added, file.uploaded
- [ ] Настроить Circuit Breaker для вызовов к Java сервисам
...
- [ ] Реализовать Background Processing Patterns
- [ ] Настроить File Processing Patterns
- [ ] Добавить Search Optimization Patterns
- [ ] Реализовать Reporting Patterns
